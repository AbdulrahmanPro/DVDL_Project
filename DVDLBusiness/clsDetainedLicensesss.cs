...
namespace DVDLBusiness
{
    public class clsDetainedLicenses
    {
        ...
        public clsUsersBusiness CreatedByUserInfo { set; get; }
        public bool IsReleased { set; get; }
        public DateTime ReleaseDate { set; get; }
        public int ReleasedByUserID { set; get; }
        public clsUsersBusiness ReleasedByUserInfo { set; get; }
...

        {
            ...
            this.CreatedByUserInfo = clsUsersBusiness.FindByUserID(this.CreatedByUserID);
            this.IsReleased = IsReleased;
            this.ReleaseDate = ReleaseDate;
            this.ReleasedByUserID = ReleasedByUserID;
            this.ReleaseApplicationID = ReleaseApplicationID;
            this.ReleasedByUserInfo = clsUsersBusiness.FindByPersonID(this.ReleasedByUserID);
            Mode = enMode.Update;
        }
        ...
        private bool _AddNewDetainedLicense()
        {
            ...
            this.DetainID = clsDetainedLicenseDatacs.AddNewDetainedLicense(
        ...
        private bool _UpdateDetainedLicense()
        {
            ...
            return clsDetainedLicenseDatacs.UpdateDetainedLicense(this.DetainID, this.LicenseID, this.DetainDate, this.FineFees, this.CreatedByUserID);
        }
        ...
        public static clsDetainedLicenses Find(int DetainID)
        {
            ...
            if (clsDetainedLicenseDatacs.GetDetainedLicenseInfoByID(DetainID,
        ...
        {
            return clsDetainedLicenseDatacs.GetAllDetainedLicenses();
        ...
        public static clsDetainedLicenses FindByLicenseID(int LicenseID)
        {
            ...
            if (clsDetainedLicenseDatacs.GetDetainedLicenseInfoByLicenseID(LicenseID,
        ...
        {
            return clsDetainedLicenseDatacs.IsLicenseDetained(LicenseID);
        }

        public bool ReleaseDetainedLicense(int ReleasedByUserID, int ReleaseApplicationID)
        {
            return clsDetainedLicenseDatacs.ReleaseDetainedLicense(this.DetainID,
                   ReleasedByUserID, ReleaseApplicationID);
        }
    }
}
